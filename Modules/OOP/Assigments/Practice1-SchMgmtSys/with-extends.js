...
class Student extends SchoolPersonnel {  //extends let us use the shared key.value 
    constructor(name, age, subjects) { //constructor runs automatically after a new student class is created
        super(name, age, subjects)  //super lets SchoolPersonnel become the parent class
    }
    register(subject) {
        this.subjects.push(subject)
    }
}
class Teacher extends SchoolPersonnel {  //extends let us use the shared key.value 
    constructor(name, age, subjects) { //constructor runs automatically after a new student class is created
        super(name, age, subjects)  //super lets SchoolPersonnel become the parent class
    }
    register(subject) {
